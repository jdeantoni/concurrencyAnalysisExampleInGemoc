package uk.ac.kcl.inf.modelling.pls.design.services;
...
public class ProductionlinediagramDebugServices extends AbstractGemocDebuggerServices {
	...
	protected List<StringCouple> getRepresentationRefreshList() {
		...
		res.add(new StringCouple("Production Line Diagram", "Debug"));
